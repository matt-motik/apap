...
- **Следующий ход:** В `ui/settings.slint`: добавить property `cache-cover-size`, заменить `cache-disk-size` на `cache-viz-size` + `cache-cover-size`, обновить строки вкладки Cache.
