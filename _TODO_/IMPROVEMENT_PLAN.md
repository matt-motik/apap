# План доработок и улучшений Music Player на Rust
...
### 5.3. Горячая перезагрузка конфигов

**Задача:** Следить за изменением файла конфига и применять изменения без перезапуска.
