...
- Ресайз окна мышью на Ubuntu GNOME FHD — проверить, что таблица **больше не «заморожена»**: колонки следуют за границей окна сразу (синхронный рефлоу), рост быстрый без «дебаунса».
